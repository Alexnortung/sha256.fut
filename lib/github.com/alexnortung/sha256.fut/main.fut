...
-- random input { [500][30]u8 }
-- random input { [1000][30]u8 }
-- comoiled random input { [2000][30]u8 }
-- comoiled random input { [3000][30]u8 }
-- comoiled random input { [4000][30]u8 }
-- comoiled random input { [10000][30]u8 }
...
-- nobench compiled random input { [1000][300]u8 }
-- nobench compiled random input { [100000][300]u8 }
